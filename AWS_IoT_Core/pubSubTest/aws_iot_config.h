...
//===============================================================
#define AWS_IOT_MQTT_HOST "a2kubsd3ykx9w4-ats.iot.ap-northeast-2.amazonaws.com" // your endpoint
#define AWS_IOT_MQTT_PORT 8883 // your port
#define AWS_IOT_CLIENT_ID "ESP32_board" // your client ID
#define AWS_IOT_MY_THING_NAME "test_ESP32" // your thing name
...
// aws_iot_config.h from ESP32 hornbill library
