...
module.exports = {
  ...
  AppEUI : 'b40839032bbbbd35',                   		// Application EUI
  DevEUI : '000c05c016103344',								// Device EUI
  version : 'v0_1',                             	// Application의 version
  ...
  userID : 'angrypig7',                            	// MQTT버전에서 Broker 접속을 위한 ID, 포털 ID 사용
  mqttClientId : function(){						// MQTT버전에서 Broker 접속을 위한 client ID(ex : ThingPlugID_0001)
	  var POST_FIX = '0001';
	  return this.userID+'_'+POST_FIX;    	
  },

  nodeID : '2bbbbd3516103344',         	// Device 구분을 위한 LTID, 디바이스 고유 ID 사용
  passCode : 'passcode1',                          	// ThingPlug에 Device등록 시 사용할 Device의 비밀번호
  uKey : 'U2l4WnM0K1dHUHRuUnY3MGo0M1JDNDl1c250TnpMOU1NWVl0dHFvWFhGL3pLVEd1ajJwbGZObXV3V1ErVTRWYw==',                	// Thingplug로그인 후, `마이페이지`에 있는 사용자 인증키

  containerName:'lora_test_1',                         	// starter kit에서 생성하고 사용할 container 이름 (임의지정)
