...
void printInfo(){
	...
	switch( String(BAND).substring(0, 3).toInt() ) {
		case 433:
			display.drawString(128, 50, "Band: 433Mhz");
			break;

		case 868:
			display.drawString(128, 50, "Band: 868Mhz");
			break;

		case 915:
			display.drawString(128, 50, "Band: 915Mhz");
			break;
	...
	display.drawString(128, 34, "TXPOW: " + String(TXPOW));
	display.drawString(128, 18, "SF: " + String(SF));
