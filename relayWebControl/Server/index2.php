...
if (isset($_POST['devnum'])) {
    ...
    if (empty($_POST['reservation']) && empty($_POST['repeat'])) {
        ...
        $SQL = "UPDATE devices SET `set_status`='$control' WHERE `dev_num`='8'";
    ...
    <div id="container" class="clear">
      ...
      <div id="homepage">
        ...
        <section id="services" class="clear">
          <?php
$iframe = '<iframe src="http://iotsv.cafe24.com/devices2.php?dev_num=#DEV_NUM#" width="320px" height="230px" overflow="auto" style="border: 0px solid transparent;"></iframe>';
